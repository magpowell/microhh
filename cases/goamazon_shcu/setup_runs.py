...
# Derived from this file's own location (cases/goamazon_shcu/setup_runs.py ->
# repo root), so the case travels between machines without editing.
# $MICROHH_DIR still wins if set, for out-of-tree checkouts.
