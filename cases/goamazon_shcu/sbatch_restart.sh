...
#SBATCH --output=/pscratch/sd/m/mpowell/GOAMAZON_SHCU_LES/logs/goamazon_shcu_restart-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/GOAMAZON_SHCU_LES/logs/goamazon_shcu_restart-%j.err
