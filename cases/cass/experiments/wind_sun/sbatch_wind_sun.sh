...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/wind_sun-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/wind_sun-%j.err
#SBATCH --mail-user=mp4257@columbia.edu
#SBATCH --mail-type=END,FAIL
#SBATCH -A m1266
#
# --constraint and --job-name are passed at submit time by submit_wind_sun.sh
...
echo "Starting ${#DIRS[@]} wind_sun simulations at $(date)"
