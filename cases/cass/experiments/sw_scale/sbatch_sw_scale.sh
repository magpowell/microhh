...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/sw_scale-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/sw_scale-%j.err
...
echo "Starting ${#DIRS[@]} sw_scale simulations at $(date)"
