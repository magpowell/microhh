...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/no_aerosols-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/no_aerosols-%j.err
...
echo "Starting ${#DIRS[@]} no_aerosols simulations at $(date)"
