...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/soil_moisture-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/soil_moisture-%j.err
#SBATCH --mail-user=mp4257@columbia.edu
#SBATCH --mail-type=END,FAIL
#SBATCH -A m1266
#
# --constraint and --job-name are passed at submit time by submit_soil_moisture.sh
...
echo "Starting ${#DIRS[@]} soil_moisture simulations at $(date)"
