...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/cs_veg-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/cs_veg-%j.err
#SBATCH --mail-user=mp4257@columbia.edu
#SBATCH --mail-type=END,FAIL
#SBATCH -A m1266
#
# --constraint and --job-name are passed at submit time by submit_cs_veg.sh
...
echo "Starting ${#DIRS[@]} cs_veg simulations at $(date)"
