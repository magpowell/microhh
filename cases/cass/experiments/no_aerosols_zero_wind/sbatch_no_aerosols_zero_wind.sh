...
#SBATCH --output=/pscratch/sd/m/mpowell/CASS_LES/logs/no_aerosols_zero_wind-%j.out
#SBATCH --error=/pscratch/sd/m/mpowell/CASS_LES/logs/no_aerosols_zero_wind-%j.err
...
echo "Starting ${#DIRS[@]} no_aerosols_zero_wind simulations at $(date)"
